/datum/role/captain
	...
	outfit_type = /decl/hierarchy/outfit/role/torch/crew/command/CO
...
/datum/role/hop
	...
	outfit_type = /decl/hierarchy/outfit/role/torch/crew/command/XO
	allowed_branches = list(
		/datum/mil_branch/expeditionary_corps,
		/datum/mil_branch/fleet = /decl/hierarchy/outfit/role/torch/crew/command/XO/fleet
	)
	allowed_ranks = list(
...
/datum/role/hop/get_description_blurb()
...
/datum/role/rd
	...
	outfit_type = /decl/hierarchy/outfit/role/torch/crew/research/cso
	allowed_branches = list(
		/datum/mil_branch/expeditionary_corps
	)
	allowed_ranks = list(
...
/datum/role/rd/get_description_blurb()
...
/datum/role/cmo
	...
	outfit_type = /decl/hierarchy/outfit/role/torch/crew/command/cmo
	allowed_branches = list(
		/datum/mil_branch/expeditionary_corps,
		/datum/mil_branch/fleet = /decl/hierarchy/outfit/role/torch/crew/command/cmo/fleet
	)
	allowed_ranks = list(
		/datum/mil_rank/fleet/o4,
...
/datum/role/cmo/get_description_blurb()
...
/datum/role/chief_engineer
	title = "Chief Engineer"
	supervisors = "the Commanding Officer and the Executive Officer"
	economic_power = 9
	ideal_character_age = 40
	minimal_player_age = 7
	outfit_type = /decl/hierarchy/outfit/role/torch/crew/command/chief_engineer
	allowed_branches = list(
		/datum/mil_branch/expeditionary_corps,
		/datum/mil_branch/fleet = /decl/hierarchy/outfit/role/torch/crew/command/chief_engineer/fleet
	)
	allowed_ranks = list(
		/datum/mil_rank/ec/o3,
		/datum/mil_rank/fleet/o3,
...
/datum/role/chief_engineer/get_description_blurb()
...
/datum/role/hos
	...
	outfit_type = /decl/hierarchy/outfit/role/torch/crew/command/cos
	allowed_branches = list(
		/datum/mil_branch/expeditionary_corps,
		/datum/mil_branch/fleet = /decl/hierarchy/outfit/role/torch/crew/command/cos/fleet
	)
	allowed_ranks = list(
		/datum/mil_rank/ec/o3,
		/datum/mil_rank/fleet/o3,
...
/datum/role/hos/get_description_blurb()
...
/datum/role/representative
	...
	outfit_type = /decl/hierarchy/outfit/role/torch/crew/representative
...
/datum/role/representative/get_description_blurb()
...
/datum/role/sea
	...
	economic_power = 8
	ideal_character_age = 45
	outfit_type = /decl/hierarchy/outfit/role/torch/crew/command/sea/fleet
	allowed_branches = list(
...
/datum/role/sea/get_description_blurb()
...
/datum/role/bridgeofficer
	...
	outfit_type = /decl/hierarchy/outfit/role/torch/crew/command/bridgeofficer
	allowed_branches = list(
		/datum/mil_branch/expeditionary_corps,
		/datum/mil_branch/fleet = /decl/hierarchy/outfit/role/torch/crew/command/bridgeofficer/fleet
	)
	allowed_ranks = list(
...
/datum/role/bridgeofficer/get_description_blurb()
