/decl/hierarchy/outfit/role/torch/crew/exploration/New()
	..()
...
/decl/hierarchy/outfit/role/torch/crew/exploration/pathfinder
	name = OUTFIT_ROLE_NAME("Pathfinder")
...
/decl/hierarchy/outfit/role/torch/crew/exploration/explorer
	name = OUTFIT_ROLE_NAME("Explorer")
...
/decl/hierarchy/outfit/role/torch/passenger/pilot
	name = OUTFIT_ROLE_NAME("Shuttle Pilot")
...
/decl/hierarchy/outfit/role/torch/crew/exploration/pilot
	name = OUTFIT_ROLE_NAME("Shuttle Pilot - Expeditionary Corps")
	uniform = /obj/item/clothing/under/solgov/utility/expeditionary/exploration
	shoes = /obj/item/clothing/shoes/dutyboots
...
/decl/hierarchy/outfit/role/torch/crew/exploration/pilot/fleet
	name = OUTFIT_ROLE_NAME("Shuttle Pilot - Fleet")
