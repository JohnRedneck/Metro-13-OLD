/datum/map/bearcat
	allowed_roles = list(/datum/role/captain, /datum/role/chief_engineer, /datum/role/doctor, /datum/role/hop, /datum/role/cyborg, /datum/role/assistant, /datum/role/engineer)
	species_to_role_whitelist = list(
		/datum/species/vox = list(/datum/role/assistant)
	)
...
/datum/role/captain/equip(var/mob/living/carbon/human/H)
	. = ..()
	if(H.client)
...
/datum/role/chief_engineer
	...
	department_flag = ENG
	outfit_type = /decl/hierarchy/outfit/role/bearcat/chief_engineer

/datum/role/doctor
	title = "Doc"
	supervisors = "the Captain and your idea of Hippocratic Oath"
	outfit_type = /decl/hierarchy/outfit/role/bearcat/doc
	alt_titles = list(
		"Surgeon")
	total_positions = 1
	spawn_positions = 1
...
/datum/role/hop
	...
	outfit_type = /decl/hierarchy/outfit/role/bearcat/mate
	hud_icon = "hudheadofpersonnel"

/datum/role/assistant
	title = "Deck Hand"
	supervisors = "literally everyone, you bottom feeder"
	outfit_type = /decl/hierarchy/outfit/role/bearcat/hand
	alt_titles = list(
		"Cook" = /decl/hierarchy/outfit/role/bearcat/hand/cook,
		"Cargo Hand",
		"Passenger")
...
/datum/role/cyborg
	...
	outfit_type = /decl/hierarchy/outfit/role/bearcat/hand/engine
	total_positions = 1
	spawn_positions = 1
...
/decl/hierarchy/outfit/role/bearcat/chief_engineer
	name = BEARCAT_OUTFIT_ROLE_NAME("Chief Engineer")
...
/decl/hierarchy/outfit/role/bearcat/doc
	name = BEARCAT_OUTFIT_ROLE_NAME("Ship's Doc")
	uniform = /obj/item/clothing/under/det/black
	suit = /obj/item/clothing/suit/storage/toggle/labcoat
	shoes = /obj/item/clothing/shoes/laceup
	pda_type = /obj/item/modular_computer/pda/medical

/decl/hierarchy/outfit/role/bearcat/mate
	name = BEARCAT_OUTFIT_ROLE_NAME("First Mate")
...
/decl/hierarchy/outfit/role/bearcat/hand
	name = BEARCAT_OUTFIT_ROLE_NAME("Deck Hand")

/decl/hierarchy/outfit/role/bearcat/hand/pre_equip(mob/living/carbon/human/H)
	..()
...
/decl/hierarchy/outfit/role/bearcat/hand/cook
	name = BEARCAT_OUTFIT_ROLE_NAME("Cook")
	head = /obj/item/clothing/head/chefhat
	suit = /obj/item/clothing/suit/chef/classic

/decl/hierarchy/outfit/role/bearcat/hand/engine
	name = BEARCAT_OUTFIT_ROLE_NAME("Junior Engineer")
	head = /obj/item/clothing/head/hardhat
	flags = OUTFIT_HAS_BACKPACK|OUTFIT_EXTENDED_SURVIVAL

/decl/hierarchy/outfit/role/bearcat/hand/engine/pre_equip(mob/living/carbon/human/H)
	..()
	if(prob(50))
		suit = /obj/item/clothing/suit/storage/hazardvest