/datum/role/submap/voxship_vox
	...
	total_positions = 4
	outfit_type = /decl/hierarchy/outfit/role/voxship/crew
...
#define VOXSHIP_OUTFIT_ROLE_NAME(role_name) ("Vox Asteroid Base - Job - " + role_name)
/decl/hierarchy/outfit/role/voxship
	hierarchy_type = /decl/hierarchy/outfit/role/voxship
	l_ear = null
	r_ear = null

/decl/hierarchy/outfit/role/voxship/crew
	name = VOXSHIP_OUTFIT_ROLE_NAME("Shoal Scavenger")
...
#undef VOXSHIP_OUTFIT_ROLE_NAME
