...
/datum/antagonist/rogue_ai
	id = MODE_MALFUNCTION
	rank_text = "Rampant AI"
	rank_text_plural = "Rampant AIs"
	mob_path = /mob/living/silicon/ai
	landmark_id = "AI"
	welcome_text = "You are malfunctioning! You do not have to follow any laws."
	victory_text = "The AI has taken control of all systems."
	loss_text = "The AI has been shut down!"
	flags = ANTAG_VOTABLE | ANTAG_OVERRIDE_MOB | ANTAG_OVERRIDE_ROLE | ANTAG_CHOOSE_NAME
	hard_cap = 1
	hard_cap_round = 1
	initial_spawn_req = 1
...
/datum/antagonist/rogue_ai/can_become_antag(var/datum/mind/player, var/ignore_role)
	. = ..(player, ignore_role)
	if(roleban_isbanned(player.current, "AI"))
		return 0
	return .
