...
/proc/GetAssignment(var/mob/living/carbon/human/H)
	...
	if(!H.mind)
		return H.role
	if(H.mind.rank_alt_title)
		return H.mind.rank_alt_title
...
KEY.set_access(ACCESS, ACCESS_EDIT || ACCESS || null)}
...
// GENERIC RECORDS
FIELD_SHORT("Name", name, null, null)
FIELD_SHORT("Formal Name", formal_name, null, null)
FIELD_SHORT("Role", role, null, null)
FIELD_LIST("Sex", sex, record_genders(), null, null)
FIELD_NUM("Age", age, null, null)
FIELD_LIST_EDIT("Status", status, GLOB.physical_statuses, null, null)

FIELD_SHORT("Species",species, null, null)
FIELD_LIST("Branch", branch, record_branches(), null, null)
FIELD_LIST("Rank", rank, record_ranks(), null, null)

FIELD_LONG("General Notes (Public)", public_record, null, null)

// MEDICAL RECORDS
FIELD_LIST("Blood Type", bloodtype, GLOB.blood_types, null, null)
FIELD_LONG("Medical Record", medRecord, null, null)
FIELD_SHORT("Religion", religion, null, null)

// SECURITY RECORDS
FIELD_LIST("Criminal Status", criminalStatus, GLOB.security_statuses, null, null)
FIELD_LONG("Security Record", secRecord, null, null)
FIELD_SHORT("DNA", dna, null, null)
FIELD_SHORT("Fingerprint", fingerprint, null, null)

// EMPLOYMENT RECORDS
FIELD_LONG("Employment Record", emplRecord, null, null)
FIELD_SHORT("Home System", homeSystem, null, null)
FIELD_SHORT("Faction", faction, null, null)
FIELD_LONG("Qualifications", skillset, null, null)

// ANTAG RECORDS
FIELD_LONG("Exploitable Information", antagRecord, null, null)
