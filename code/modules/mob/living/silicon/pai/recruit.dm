...
/datum/paiController/proc/recruitWindow(var/mob/M as mob, allowSubmit = 1)
	...
	<body>
		...
		<table>
			...
			<tr class="d1">
				<td>Do you like to partner with sneaky social ninjas? Like to help security hunt down thugs? Enjoy watching an engineer's back while he saves the day yet again? This doesn't have to be limited to just actually-existing-in-game roles. Pretty much any general descriptor for what you'd like to be doing works here.</td>
			</tr>
			<tr class="d0">
